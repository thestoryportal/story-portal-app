...
## How to reproduce
- This capture was automated via scenario: animations/${scenarioName}/scenario.json
...
function readArgs() {
  ...
  if (!scenario) die("Usage: node animations/shared/iterate.mjs <scenarioName>");
  return { scenario };
}
...
async function main() {
  ...
  const res = spawnSync(
    ...
    [
      ...
      scenario,
      "--scenario",
      `animations/${scenario}/scenario.json`,
      "--outDir",
      runDir
    ],
