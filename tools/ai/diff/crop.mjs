 ...
 *   node tools/ai/diff/crop.mjs --scenario electricity-portal --input /path/to/frames --output /path/to/focus
 *
 *   # Crop using explicit region
 *   node tools/ai/diff/crop.mjs --input /path/to/frames --output /path/to/focus --crop 227:248:826:824
 */
...
function loadCropFromScenario(scenarioName) {
  const scenarioPath = path.join(PROJECT_ROOT, 'tools/ai/scenarios', `${scenarioName}.json`);
...
Usage:
  node tools/ai/diff/crop.mjs --input <dir> --output <dir> [options]
