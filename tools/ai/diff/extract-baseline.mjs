 ...
 *
 * Usage:
 *   node tools/ai/diff/extract-baseline.mjs \
 *     --with reference_with_effect.png \
 *     --without reference_without_effect.png \
 *     --output tools/ai/references/electricity-portal/
 *
...
Usage:
  node tools/ai/diff/extract-baseline.mjs --with <image> [--without <image>] --output <dir>
